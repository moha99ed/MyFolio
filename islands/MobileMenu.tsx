...
export default function MobileMenu() {
 ...
 return (
   <>
     {/* Mobile menu button */}
     <button 
       class="md:hidden text-gray-600 hover:text-gray-900 relative"
       onClick={toggleMenu}
       style={{ padding: '8px' }}
     >
     ...
     {/* Mobile menu overlay */}
     {isOpen && (
       <div class="fixed inset-0 bg-white bg-opacity-95 z-50 md:hidden">
         {/* Menu content */}
         <div class="relative w-full h-full flex flex-col px-6">
           ...
           <div class="flex justify-between items-center pt-6 pb-8">
             ...
             <button 
               onClick={closeMenu}
               class="text-gray-700 hover:text-gray-900 text-3xl w-10 h-10 flex items-center justify-center bg-white bg-opacity-80 rounded-full shadow-md"
             >
               ×
             </button>
           </div>
