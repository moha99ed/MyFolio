...
export default function GrowthPlan() {
  return (
     <Layout 
      title="Professional Growth Plan - Mohammed Sebbagh<"
      description="Individualized professional growth plan focused on culturally responsive physics education and continuous improvement."
      currentPath="/growth-plan"
    >
    <>  
